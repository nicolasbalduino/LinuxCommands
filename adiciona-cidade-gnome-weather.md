# Adicionar cidade no Gnome Weather

1. Crie o script na pasta home do seu usuário:

```
vi /home/<user>/add-location-to-gnome-weather.sh
```

2. Inicie a escrita (aperte a tecla I):
3. Cole o conteúdo:
...
```
sh /home/<user>/add-location-to-gnome-weather.sh
```

6. Quando perguntar a localidade, digite o nome da sua cidade
7. Confira se a localização está correta e tecle 'y' para adicionar

Após isso, o Gnome Weather terá sua cidade como alterantiva para mostrar o clima.
